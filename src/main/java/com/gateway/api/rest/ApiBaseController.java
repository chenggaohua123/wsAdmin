...
public abstract class ApiBaseController {
	...
	public static final Log log = LogFactory.getLog(ApiBaseController.class);
	...
	public Map<String,String> apiException(APIException e,HttpServletRequest request){
		Map<String, String> expMap = new HashMap<String, String>();
		expMap.put("respCode", e.getRespCode());
		expMap.put("respDesc", e.getRespDesc());
		return expMap;
	}
