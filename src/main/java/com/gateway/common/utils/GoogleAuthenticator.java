...
public class GoogleAuthenticator {  
    ...
    public static final String SEED = "llE85E1D7521662D53E57A165F1EA29C2B855C6DE9EA1D6B3F";
//    public static final String SEED = "g8GjEvTbW5oVSV7avLBdwIHqGlUYNzKFI7izOF8GwLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZx";  
    ...
    /**
     * 下载二维码
     * @param qrBarcodeURL getQRBarcodeURL返回的QRBarcodeURL地址
     * @param qrImageURL 图片存放的位置
     * @throws IOException
     */
    public static void getQRBarcodeImage(String qrBarcodeURL,String qrImageURL) throws IOException{
		File file= new File(qrImageURL);
		if(file.exists()){//如果存在就删除
			file.delete();
		}
    	URL url = new URL(qrBarcodeURL);
    	//打开网络输入流
    	DataInputStream dis = new DataInputStream(url.openStream());
    	//建立一个新的文件
    	FileOutputStream fos = new FileOutputStream(new File(qrImageURL));
