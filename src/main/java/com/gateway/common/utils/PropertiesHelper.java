...
/**
 * Properties的操作的工具�?为Properties提供�?��代理增加相关工具方法�?getRequiredString(),getInt(),getBoolean()等方�? * 并可以�?过systemPropertiesMode属�?指定是否搜索System.getProperty()及System.getenv()来查找�?.
 * 默认不搜索系统属�? * 
 * <pre>
 * 使用1:
...
public class PropertiesHelper {
	...
	/**
	 * 尝试从System.getProperty(key)及System.getenv(key)得到�?	 * @return
	 */
