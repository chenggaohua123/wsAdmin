...
<body>
<form id="pagerForm" method="post" action="<%=path %>/riskmgr/queryCountryList">
...
<div class="pageHeader">
	<form rel="pagerForm" id="getBrandInfo" method="post" action="<%=path %>/riskmgr/queryCountryList" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
	...
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		...
		<tbody>
			<c:forEach items="${page.data }" var="terInfo">
				<tr>
				    <td><input type="checkbox" name="orgId" id="${terInfo.countryNameSimple }"  value="{ countryNameSimple:'${terInfo.countryNameSimple }'}"/></td>
					<td>${terInfo.countryNameCN }</td>
					<td>${terInfo.countryNameEN }</td>
					<td>${terInfo.countryNameSimple }</td>
