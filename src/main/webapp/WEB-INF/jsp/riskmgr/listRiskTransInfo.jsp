...
<body>
<form id="pagerForm" method="post" action="<%=path %>/riskmgr/listRiskTransInfo">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/riskmgr/listRiskTransInfo" method="post">
	<div class="searchBar">
