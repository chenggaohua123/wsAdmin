	...
	<body>
		...
		<form method="post" id="formid" action="<%=path %>/transInfoLog/insertTransInfoLog" class="pageForm required-validate"
			...
			<div class="pageFormContent" layoutH="56">
				...
				<p>
					<label>操作金额：</label>
					<font><input type="text" name="transMoney" id="transMoney" value="0">${info.merBusCurrency }</font>
				</p>
				<p>
					<label>备注：</label>
					<textarea rows="3" cols="30" name="remark" id="remark"></textarea>
				</p>
			</div>
			<div class="formBar">
				<ul>
