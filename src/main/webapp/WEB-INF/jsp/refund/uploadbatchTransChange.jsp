...
1.上传文件为txt类型 <br>
2.文件内容:交易流水号,变更金额,变更类型<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条订单<br>
5.变更类型 1 退款 2 拒付 3 冻结 4 解冻<br>
6.变更金额为标签金额<br>
例如:<br>	
BR1506161604560740,20.01,1<br>
BR1506161604560741,20.01,2<br>
BR1506161604560741,20.01,3<br>
BR1506161604560741,20.01,4<br>
BR1506161604560741,20.01,2<br>	
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/transInfoLog/updateBatchTransChange',
        dataType: 'json',
        allowedTypes: 'text/*',
