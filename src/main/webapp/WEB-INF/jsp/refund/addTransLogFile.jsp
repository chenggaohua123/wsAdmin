...
<title>批量上传交易变更信息</title>
</head>
<body>
<font color="red"><b>上传注意事项:<br>
1.上传文件为txt类型 <br>
2.文件内容:流水号,操作类型,操作金额,备注<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条交易变更信息<br>
5.每次上传流水号不能重复,重复流水号不能添加成功<br>
6.上传时请确保该流水没有待审核交易变更，否则不能添加成功<br>
7.操作类型只有：退款；拒付；冻结；解冻；<br>
例如:<br>
BR1508100956058644,0.1,0.1,备注1<br>
BR1508100956058644,0.1,0.1,备注2<br>
BR1506231111154493,0.1,0.1,备注3<br>
</b></font>
