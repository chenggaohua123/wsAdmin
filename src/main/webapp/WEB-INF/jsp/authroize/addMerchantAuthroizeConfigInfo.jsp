...
<title>添加商户预授权配置</title>
</head>
<body>
<div class="pageContent" >
 <form method="post" action="<%=path %>/merchantAuthroizeConfigInfo/addMerchantAuthroizeConfigInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
