...
<div class="pageContent">
	<form method="post" action="<%=path %>/settlemgr/checkMerchantAccountAccess" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
      <input type="hidden" name="id" value="${info.id }">
        <div class="pageFormContent" layoutH="56">
            ...
            <p>
				...
				<option value="4" ${info.cashType==5||info.cashType==7?'selected':'' }>罚款</option>
            ...
            <p id="checkRemark" >
                <label>备注：</label>
               <input name="checkRemark" type="text" size="30" class="required"/>
            </p>
        </div>
        <div class="formBar">
            <ul>
