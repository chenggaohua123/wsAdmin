...
<div class="pageContent">
	<form method="post" action="<%=path %>/settlemgr/reCheckMerchantAccountAccess" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
