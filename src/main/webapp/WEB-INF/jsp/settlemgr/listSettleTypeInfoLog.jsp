...
<body>
<form id="pagerForm" method="post" action="<%=path %>/settlemgr/listSettleTypeInfoLog">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dialogSearch(this);" action="<%=path %>/settlemgr/listSettleTypeInfoLog" method="post">
	<div class="searchBar">
