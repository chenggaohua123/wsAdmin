...
function downloadTransModel(){
	location.href="<%=path %>/settlemgr/downBatchMoneyFile";
}
</script>
<body>
<div class="pageHeader" >
<button onclick="downloadTransModel()">下载批量出款模板&nbsp;<span id="c_spanInfo" onclick="downloadTransModel()"></span>&nbsp;模板</button>
<div id="c_div_2" style="display:block;">
	<font color="red">
		<b>上传注意事项:<br>
		1.上传文件为txt类型 <br>
		2.文件内容:Id,出款时间,出款备注<br>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/settlemgr/acceptBatchMoneyFile',
        dataType: 'json',
        allowedTypes: 'text/*',
        ...
        onUploadSuccess: function(id, data){
          ...
          openWindow("<%=path %>/settlemgr/goShowBatchMoneyInfo");
