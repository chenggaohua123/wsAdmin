...
<title>批量上传拒付单信息</title>
</head>
<body>
<font color="red"><b>上传注意事项:<br>
1.上传文件为txt类型 <br>
2.文件内容:流水号,投诉日期,投诉问题,投诉级别,投诉处理状态,投诉补充说明,投诉处理截止日期<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条交易信息，交易信息必须为成功单<br>
5.每次上传流水号不能重复,重复流水号不能添加成功<br>
6.上传时请确保该流水没有投诉单信息，否则不能添加成功<br>
7.投诉原因请填写投诉原因管理--投诉类型原因的序号<br>
8.投诉级别：0表示一般；1表示紧急<br>
9.投诉处理状态：0表示未处理；1表示已退款；2表示已处理；3表示商户自行协商<br>
10.投诉日期、投诉处理截止日期 为：yyyy-MM-dd HH:mm:ss<br>
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/complaint/batchAddDishonorInfo?type=2',
        dataType: 'json',
        allowedTypes: 'text/*',
