...
function batchAcceptCheckUpdateById(){
	...
	if(!str){
		...
		var url="<%=path %>"+"/complaint/batchUpdateCPDDate";
		$.ajax({
			url:url,
			type:'post',
			dataType:'json',
...
<div style="width:100%;height:100%;clear:#183152;text-align: left;">
		<a class="edit" href="javaScript:batchAcceptCheckUpdateById()"><span style="color:green;">批量修改</span></a>
	...
	<table class="list" width="100%" targetType="navTab" layoutH="140" style="text-align: center;">
		...
		<tbody>
			<c:forEach items="${updateCPDList}" var="trans">
