...
<title>批量上传伪冒单信息</title>
</head>
<body>
<font color="red"><b>上传注意事项:<br>
1.上传文件为txt类型 <br>
2.文件内容:流水号,伪冒通知时间<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条交易信息，交易信息必须为成功单<br>
5.每次上传流水号不能重复,重复流水号不能添加成功<br>
6.上传时请确保该流水没有伪冒单信息，否则不能添加成功<br>
7.伪冒单通知时间 格式为：yyyy-MM-dd HH:mm:ss<br>
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/complaint/batchAddDishonorInfo?type=3',
        dataType: 'json',
        allowedTypes: 'text/*',
