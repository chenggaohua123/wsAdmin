...
1.上传文件为txt类型 <br>
2.文件内容:流水号,拒付通知时间,拒付原因,拒付处理截止时间,CPD日期,商户可见,特殊拒付,拒付金额<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条交易信息，交易信息必须为成功单<br>
5.每次上传流水号不能重复,重复流水号不能添加成功<br>
6.上传时请确保该流水没有拒付单信息，否则不能添加成功<br>
7.拒付原因请填写投诉原因管理--拒付类型原因的序号<br>
8.拒付通知时间、拒付处理截止时间、CPD日期格式为：yyyy-MM-dd HH:mm:ss<br>
9.商户可见 0 商户不可见 1 <br>
10.非特殊拒付 0 特殊拒付 1 <br>
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/complaint/batchAddDishonorInfo?type=1',
        dataType: 'json',
        allowedTypes: 'text/*',
