...
1.上传文件为txt类型 <br>
2.文件内容:流水号,调查单通知时间,调查原因,调查单处理截止时间<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条交易信息，交易信息必须为成功单<br>
5.每次上传流水号不能重复,重复流水号不能添加成功<br>
6.上传时请确保该流水没有调查单信息，否则不能添加成功<br>
7.调查原因请填写投诉原因管理--调查类型原因的序号<br>
8.调查单通知时间、调查单处理截止时间 格式为：yyyy-MM-dd HH:mm:ss<br>
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/complaint/batchAddDishonorInfo?type=0',
        dataType: 'json',
        allowedTypes: 'text/*',
