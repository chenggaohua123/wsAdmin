...
<body>
<form id="pagerForm" method="post" action="<%=path %>/bankOrder/getBankRefundList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader" >
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/bankOrder/getBankRefundList" method="post">
	<div class="searchBar" >
		<ul class="searchContent">
		 	<li style="width: 250px;">
		 		<label>银行名称：</label>
				<select class="combox" name="bankId" id="bankId">
		 	...
		 	<li style="width: 250px;">
		 		<label>通道名称：</label>
		 		<select class="combox" loadurl="<%=path %>/bankOrder/queryCurrencyIfoList?bankId=52/97/57&currencyId=2A/2B/2C/2BM/47A" relValue="id" selectedValue="${param.currencyId }" relText="currencyName" name="currencyId" id="currencyId" onchange="getBankId()">
