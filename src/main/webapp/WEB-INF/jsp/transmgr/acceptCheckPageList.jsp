...
function batchAcceptCheckUpdateById(){
	...
	if(!str){
		...
		var url="<%=path %>"+"/transmgr/batchAcceptCheckUpdateById";
		$.ajax({
			url:url,
			type:'post',
			dataType:'json',
...
<body>
<div id="div_data" class="pageContent" style="display:none;">
	<div class="panelBar"><br/><h3 style="color:red;">未匹配数据</h3></div>
	<div id="showData"></div>
</div>
<div id="div_data1" class="pageContent" style="display:none;">
	<div class="panelBar"><br/><h3 style="color:red;">掉单数据</h3></div>
	<div id="showData1"></div>
</div>
<div id="div_data2" class="pageContent" style="display:none;">
	<div class="panelBar"><br/><h3 style="color:red;">重复支付数据</h3></div>
	<div id="showData2">
		<c:forEach items="${duplicateTradeNos }" var="tradeNo">
			流水号：${tradeNo }<br>
		</c:forEach>
	</div>
</div>
<div class="pageContent" style="width:100%;height:100%;clear:#183152;">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="javaScript:batchAcceptCheckUpdateById()"><span style="color:green;">批量勾兑</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="javaScript:showData()"><span style="color:green;">显示未匹配数据</span></a></li>
			<li><a class="edit" href="javaScript:showData1()"><span style="color:green;">显示掉单数据</span></a></li>
			<li><a class="edit" href="javaScript:showData2()"><span style="color:green;">显示重复支付数据</span></a></li>
			<li><span style="color:red;">警告：支付失败单，勾兑后将会变成支付成功单</span></li>
		</ul>
	</div>
	...
	<table class="list" width="100%" targetType="navTab" layoutH="140" style="text-align: center;">
		...
		<tbody>
			<c:forEach items="${list}" var="trans">
				<tr  target="transCheckID" rel="${trans.id }"   >
					<td>
						<input type="hidden" id="ids${trans.id}">
						<input type="checkbox" name="selectAcceptAll_ids" value="${trans.id}">
					</td>
					<td>${trans.merNo }</td>
					<td>${trans.terNo }</td>
					<td>${trans.tradeNo }</td>
