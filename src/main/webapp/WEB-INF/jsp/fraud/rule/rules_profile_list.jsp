...
<body>
<form id="pagerForm" method="post" action="fraud/rule/queryRuleProfile">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="fraud/rule/queryRuleProfile" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="fraud/rule/goAddRulesProFile" target="dialog" mask="true" width="600" ><span>添加</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="fraud/rule/goUpdateRulesProFile?profileId={profileId}" target="dialog" width="500" height="370" mask="true" ><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="fraud/rule/goRefRuleProfileLits?profileId={profileId}" target="dialog" width="800" height="500" mask="true" ><span>添加规则到集合</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="fraud/rule/queryRefRuleProfileLits?profileId={profileId}" target="dialog" width="800" height="500" mask="true" ><span>查询集合关联规则</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
