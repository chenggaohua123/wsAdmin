...
<body>
<form id="pagerForm" method="post" action="fraud/rule/queryParamList">
...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="fraud/rule/queryParamList" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
