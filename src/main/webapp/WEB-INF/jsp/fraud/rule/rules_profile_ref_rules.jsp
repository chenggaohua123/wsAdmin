...
%>  
<body>
<form id="pagerForm" method="post" action="<%=path %>/fraud/rule/goRefRuleProfileLits?profileId=${profileId}">
...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="<%=path %>/fraud/rule/goRefRuleProfileLits?profileId=${profileId}" rel="pagerForm"  method="post" class="pageForm	">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="确实要添加这些记录吗?" target="selectedTodo" targetType="dialog" rel="rulesId" href="fraud/rule/addRulesToRulesProFile?profileId=${profileId}" class="add"><span>批量添加</span></a></li>
		</ul>
	</div>
