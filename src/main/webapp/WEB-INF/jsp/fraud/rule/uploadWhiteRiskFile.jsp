...
function downloadTransModel(){
	location.href="<%=path %>/whiteListMagage/downloadWhiteFile";
}
</script>
<body>
<div class="pageHeader" >
	上传：商户号,终端号,规则类型,处理方式,规则信息,状态,备注
<button onclick="downloadTransModel()">下载&nbsp;<span id="spanInfo" onclick="downloadTransModel()">批量添加白名单</span>&nbsp;模板</button>
<div id="div_1" style="display:none;">
	<font color="red">
		<b>上传注意事项:<br>
		1.上传文件为txt类型 <br>
		2.文件内容:商户号,终端号,规则类型,处理方式,规则信息,状态,备注<br>
...
<script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/whiteListMagage/uploadWhiteFile',
        dataType: 'json',
        allowedTypes: 'text/*',
        ...
        onUploadSuccess: function(id, data){
          ...
          openWindow("<%=path %>/whiteListMagage/showUploadWhiteRiskInfo");
        },
