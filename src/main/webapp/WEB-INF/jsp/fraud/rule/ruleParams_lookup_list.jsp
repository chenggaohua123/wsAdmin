...
<body>
<form id="pagerForm" method="post" action="fraud/rule/queryRuleParamList">
...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="fraud/rule/queryRuleParamList" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
