...
<div class="pageContent">
	 <form method="post" action="fraud/rule/updateRules" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	    <div class="pageFormContent" layoutH="56">
	         ...
	         <p>
	             ...
	             <a class="btnLook" href="fraud/rule/queryParamList?comFrom=1" target="dialog" lookupGroup="" lookupPk="paramDescName"  mask="true"  width="650" height="400">查找带回</a>		
	         </p>
	         <p>
	             <label>匹配方式：</label>
	             <input type="hidden" name="processClassId" id="processClassId" value="${info.processClassId }">
	             <input name="processClassName" id="processClassName" readonly="readonly" value="${info.processClassName }" type="text" size="30" class="required" suggestFields="processClassId,processClassName" suggestUrl="fraud/rule/queryProcessClassList"/>
	         ...
	         <p>
	            ...
	            <input type="hidden" name="ruleParamValueId" id="ruleParamValueId" value="${info.ruleParamValueId }">
	             ...
	             <a class="btnLook" href="fraud/rule/queryRuleParamList" target="dialog" lookupGroup="" lookupPk="ruleParamValueDescName"  mask="true"  width="650" height="400">查找带回</a>
	         </p>
	         <p>
	             <label>状态：</label>
