...
<body>
<form id="pagerForm" method="post" action="suspicious/queryRuleParamList">
...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="suspicious/queryRuleParamList" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
		...
		<tbody>
			<c:forEach items="${requestScope.result.data}" var="r"
				...
				<tr target="paramId" rel="${r.paramId}">
					...
					<td>
					<a class="btnSelect" href="javascript:$.bringBack({ruleParamValueId:'${ r.paramId}', ruleParamValueDescName:'${r.paramDescName }'})" title="查找带回">选择</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
