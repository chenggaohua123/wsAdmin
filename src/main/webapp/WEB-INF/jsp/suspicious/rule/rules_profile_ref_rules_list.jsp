...
<body>
<form id="pagerForm" method="post" action="suspicious/queryRefRuleProfileLits?profileId=${param.profileId }">
...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="suspicious/queryRefRuleProfileLits?profileId=${param.profileId }" rel="pagerForm"  method="post" class="pageForm">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="确实要添加这些记录吗?" target="selectedTodo" targetType="dialog" rel="rulesId" href="suspicious/delRulesFromRulesProFile?profileId=${param.profileId }" class="delete"><span>批量删除</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
