...
<body>
<form id="pagerForm" method="post" action="suspicious/params_list">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="suspicious/params_list" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="suspicious/goAddParams" target="dialog" width="500" mask="true"><span>添加</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="suspicious/goUpdateParams?id={paramId}" target="dialog" width="500" mask="true"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" href="suspicious/delParamByParamId?paramId={paramId}" target="ajaxTodo" title="请慎重删除,确定删除该参数吗?" mask="true"><span>删除</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="suspicious/goParams_setParamValue?paramId={paramId}" target="dialog" mask="true"  width="600" height="380"><span>设置参数值</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
				...
				<tr target="paramId" rel="${r.paramId}">
					...
					<td>
						<c:if test="${r.comFrom == '2' }">
							<a href="suspicious/params_Value?paramId=${r.paramId}" target="dialog" mask="true" target="dialog" style="color: blue;" minable="false" atl="查看参数的值" width="500" height="400">${r.type}</a>
						</c:if>
