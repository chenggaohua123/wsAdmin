...
<body>
<form id="pagerForm" method="post" action="suspicious/queryAccountRefProfileList">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="suspicious/queryAccountRefProfileList" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="suspicious/goAddProfileToAccount" rel="addProfileToAccount" target="dialog" width="500" height="370" mask="true"><span>添加</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" href="suspicious/delAccountFromList?id={id}" target="ajaxTodo" title="确定删除该关联信息吗?"><span>删除</span></a></li>
			
			<li class="line">line</li>
			<li><a class="edit" href="suspicious/goUpdateAccountRefProfileInfoById?id={id}" rel = "updateProfileToAccount" target="dialog" width="500" height="370" mask="true" ><span>修改</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
