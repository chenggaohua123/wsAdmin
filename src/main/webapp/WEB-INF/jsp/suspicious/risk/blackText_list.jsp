...
<body>
<form id="pagerForm" method="post" action="suspicious/queryBlackInfoList">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="suspicious/queryBlackInfoList" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="suspicious/goAddBlackText" mask="true" target="dialog" width="500"><span>添加</span></a></li>
			<!-- <li><a class="add" href="fraud/rule/goBatchAddBlackText" mask="true" target="navTab" width="500"><span>批量添加</span></a></li> -->
			<li><a class="delete" href="suspicious/delBlackTextById?blackId={blackId}" target="ajaxTodo" title="确定删除该元素吗?"><span>删除</span></a></li>
		</ul>
	</div>
