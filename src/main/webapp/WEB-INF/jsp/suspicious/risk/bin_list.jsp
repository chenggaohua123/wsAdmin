...
<body>
<form id="pagerForm" method="post" action="suspicious/queryBinList">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="suspicious/queryBinList" method="post" rel="pagerForm" class="pageForm required-validate">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="suspicious/goAddBinInfo" mask="true" target="dialog" width="500"><span>添加</span></a></li>
			<!-- <li><a class="add" href="fraud/rule/goBatchAddBinInfo" mask="true" target="navTab" width="500"><span>批量添加</span></a></li> -->
			<li><a class="delete" href="suspicious/delBinInfotById?id={id}" target="ajaxTodo" mask="true" rel="123" title="确定删除该元素吗?"><span>删除</span></a></li>
		</ul>
	</div>
