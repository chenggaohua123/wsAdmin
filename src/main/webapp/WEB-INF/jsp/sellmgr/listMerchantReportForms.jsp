...
<body>
<form id="pagerForm" method="post" action="<%=path %>/sellmgr/listMerchantReportForms">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/sellmgr/listMerchantReportForms" method="post">
	<div class="searchBar">
		...
		<tbody>
			<c:forEach items="${page.data }" var="info">
				<tr >
					...
					<td>
					<a  href="<%=path %>/sellmgr/exportMerchantReportForms?merNo=${info.merNo}&startDate=${info.startDate}&endDate=${info.endDate}&formType=${info.formType}"  targetType="navTab"rel="addCurre111ncy" width="550" height="300" mask="true">导出报表</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
