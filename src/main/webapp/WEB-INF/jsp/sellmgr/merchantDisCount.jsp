...
<body>
<form id="pagerForm" method="post" action="<%=path %>/sellmgr/merchantDisCountList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/sellmgr/merchantDisCountList" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<li><a class="add" href="<%=path %>/sellmgr/exportMerchantDisCountInfo" target="dwzExport" targetType="navTab"rel="addCurrency" width="550" height="300" mask="true"><span>导出</span></a></li>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach items="${page.data }" var="info">
				<tr >
					...
					<td><a class="add" href="<%=path %>/sellmgr/listCurrencyDisCountDesc?merNo=${info.merNo}&terNo=${info.terNo }&countYear=${info.countYear}&countMonth=${info.countMonth}&cardType=${param.cardType}" target="dialog" rel="addCurren11cy" width="850" height="400" mask="true" rel="rateRelMerc11hant"><span>详情</span></a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
