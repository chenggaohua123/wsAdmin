...
<body>
<form id="pagerForm" method="post" action="<%=path %>/sellmgr/getListMerchant">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/sellmgr/getListMerchant" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<%=path %>/sellmgr/queryMerchantById?id={sid_role}" target="dialog" width="1200" height="400" warn="请选择一个商户" mask="true"><span>详情查询</span></a></li>
