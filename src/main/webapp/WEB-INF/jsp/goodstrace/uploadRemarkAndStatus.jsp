...
<title>运单状态与备注修改</title>
</head>
<body>
<font color="red"><b>上传注意事项:<br>
1.上传文件为txt类型 <br>
2.文件内容:流水号,货运查询状态,备注说明<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条订单<br>
例如:<br>	
BR1506161604560741,0,未妥投<br>	
BR1506161604560740,1,已妥投<br>
BR1506161604560740,2,查询不到<br>
BR1506161604560741,3,重复单号<br>	
BR1506161604560740,4,问题单号<br>
BR1506161604560741,5,退件<br>	
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/delivery/acceptCheckRemarkAndStatus',
        dataType: 'json',
        allowedTypes: 'text/*',
