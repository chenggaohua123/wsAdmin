...
<div class="pageContent">
	 <form method="post" action="warnmgr/updateTransWarnRuleInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	    <div class="pageFormContent" layoutH="56">
	    	<p>
	             <label>商户号：</label>
                <input name="merNo" type="text" id="merNo" size="30" class="required number" readonly="readonly" value="${requestScope.warn.merNo }"/>
	         ...
	         <p>
	             ...
	             <select id="type" name="type" class="required combox">
			           ...
			           <option value="3" <c:if test="${requestScope.warn.type=='3' }">selected</c:if> >风险订单</option>
			     </select>
	         </p>
	         <p>
	             <label>监控时效：</label>
