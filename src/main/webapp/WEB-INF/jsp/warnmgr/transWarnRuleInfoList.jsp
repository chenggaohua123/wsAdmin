  ...
  <div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		    ...
		    <li><a class="edit" href="<%=path %>/warnmgr/goUpdateTransWarnRule?id={id}" target="dialog" width="550" height="400" rel="update" mask="true"><span>修改</span></a></li>
		    <%--
		    ...
		    <li><a class="add" href="<%=path %>/warnmgr/goAddMessageModel?warnId={id}" target="dialog" width="550" height="400" mask="true"  rel="addMessage" ><span>添加短信内容</span></a></li>
		    <li><a class="edit" href="<%=path %>/warnmgr/goUpdateMessageModelInfo?warnId={id}" target="dialog" width="550" height="400" mask="true"  rel="updateMessage" ><span>修改短信内容</span></a></li>
		    <%--
