...
function showData(){
	<%-- <%=path %>/transchangemgr/transExportData?sb=${sb} --%>
	$("#div_data").show();
	var data = '${sb}';
	var arr = data.split(';');
	var str = '<br/>';
...
function goExportTransInfo(){
	location.href="<%=path %>/transchangemgr/exportTransInfo";
}
</script>
<body>
...
<div class="pageContent" style="width:100%;height:100%;clear:#183152;">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="#" onclick="goExportTransInfo()"><span style="color:green;">交易导出</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="#" onclick="showData()"><span style="color:green;">显示未匹配数据</span></a></li>
		</ul>
	</div>
