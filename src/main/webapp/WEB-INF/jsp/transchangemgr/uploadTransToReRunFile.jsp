...
<title>上传交易重跑文件</title>
</head>
<body>
<font color="red"><b>上传注意事项:<br>
1.上传文件为txt类型 <br>
2.文件内容:交易流水号,通道ID,是否提交银行订单 注:通道ID为空或者0时 重跑延用以前的通道ID,是否提交银行订单 0 未提交 1 已提交,是否过风控 0 不过 1 过 <br>
3.一行内容为一条订单<br>
4.交易重跑内容必须为3列<br>
例如:<br>	
BR1506161604560740,13,0,0<br>
BR1506161604560741,0,1,1<br>	
BR1506161604560740,13,0,0<br>	
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/transchangemgr/acceptTransToRunFile',
        dataType: 'json',
        allowedTypes: 'text/*',
