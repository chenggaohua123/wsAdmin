...
<body>
<form id="pagerForm" method="post" action="<%=path %>/deliveryM/queryDeliveryInfo">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/deliveryM/queryDeliveryInfo" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<%=path %>/deliveryM/exportDelivery" target="dwzExport" targetType="navTab"rel="addCurrency" width="550" height="300" mask="true"><span>导出交易运单信息</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
		...
		<tbody>
			<c:forEach items="${page.data}" var="deliveryInfo">
				<tr target="id" rel="${deliveryInfo.id }">
					...
					<td>${deliveryInfo.currency} ${deliveryInfo.amount}</td>
