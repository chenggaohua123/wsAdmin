...
function show(){
	...
	$.ajax({
        type:"POST",
        data:"",
        url:"<%=path%>/countAnalysis/countCountryListForPic"+param,
        dataType:"json",
...
<body>
<form id="pagerForm" method="post" action="<%=path %>/countAnalysis/countCountryList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/countAnalysis/countCountryList" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<li><a class="add" href="<%=path %>/countAnalysis/uploadCountryList" target="dwzExport" targetType="navTab"rel="addCurrency" width="550" height="300" mask="true"><span>导出</span></a></li>
