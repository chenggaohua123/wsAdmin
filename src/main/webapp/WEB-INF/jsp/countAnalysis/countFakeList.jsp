...
<body>
<form id="pagerForm" method="post" action="<%=path %>/countAnalysis/countFakeList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/countAnalysis/countFakeList" method="post">
	<div class="searchBar">
			...
			<tbody>
				<c:forEach items="${page.data}" var="info">
					<tr  >
						...
						<td>
						<!-- a  href="<%=path %>/countAnalysis/showFakePer?merNo=${param.merNo}&time=${info.time}"  target="dialog" width="650" height="300" rel="query11Conf1111ig"  mask="true">投诉构成</a> |  -->
						<a  href="<%=path %>/countAnalysis/downloadFakeCountInfo?merNo=${param.merNo}&time=${info.time}" target="dwzExport" targetType="navTab"rel="addCurre11111ncy" width="550" height="300" mask="true">导出明细</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
