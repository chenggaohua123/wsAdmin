		...
		"oLanguage" : { //主要用于设置各种提示文本
			...
			"aoColumnDefs": [
			{
				...
				"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
					...
					var tradeNos=strs[1];
					if(time!='0'){
						var str = '<a href="javascript:showRes(\''+time+'\')" >拒付构成</a> | <a href="javascript:downloadTransInfo(\''+tradeNos+'\')">导出明细</a>';
						$(nTd).html(str);
					}else{
						$(nTd).html("");
					}
...
function showRes(time){
	...
	$.ajax({
		...
		success: function(json){
            $("#alert #myModalLabel").text("拒付占比");
            str="<table border=\"0\" cellspacing=\"1px\" bgcolor=\"black\" width='100%'>";
            str+="<tr bgcolor='white'><td>拒付原因</td><td>拒付条数</td><td>拒付占比</td></tr>";
          ...
          <br>
          	  <div class="span12 btn-icon-pg" id="selectForm">
                 	...
                 	　　	时间周期选择：<select name="year" id="year"  onchange="monthChange()" style="width:50%;">
								...
								<font color='red'>总拒付率=总拒付通知笔数/总交易成功笔数*100%<br>
月拒付率=当月通知拒付笔数/当月交易成功笔数*100%</font>
