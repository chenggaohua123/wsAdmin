...
function show(){
	...
	$.ajax({
        type:"POST",
        data:"",
        url:"<%=path%>/countAnalysis/queryTransHourCountForPic"+param,
        dataType:"json",
...
<form id="pagerForm" method="post" action="<%=path %>/countAnalysis/queryTransHourCount">
</form>
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/countAnalysis/queryTransHourCount" method="post">
