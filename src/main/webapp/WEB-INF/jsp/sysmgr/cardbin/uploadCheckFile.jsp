...
function downloadTransModel(){
	location.href="<%=path %>/sysmgr/downBatchUpdateCardBinFile";
}
</script>
<body>
<div class="pageHeader" >
<button onclick="downloadTransModel()">下载批量卡号上传模板&nbsp;<span id="c_spanInfo" onclick="downloadTransModel()"></span>&nbsp;模板</button>
<div id="c_div_2" style="display:block;">
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/sysmgr/acceptBatchCardBinInfoFile',
        dataType: 'json',
        allowedTypes: 'text/*',
        ...
        onUploadSuccess: function(id, data){
          ...
          openWindow("<%=path %>/sysmgr/goShowBatchCardBinInfo");
