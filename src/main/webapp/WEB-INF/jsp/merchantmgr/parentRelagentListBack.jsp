...
<body>
<form id="pagerForm" method="post" action="<%=path %>/merchantmgr/parentRelAgentBack">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dialogSearch(this);" action="<%=path %>/merchantmgr/parentRelAgentBack" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div id="w_list_print">
	<table class="list" width="98%" targetType="navTab" layoutH="85">
		<thead>
			<tr>
				<th>商户号</th>
				<th>父级代理号</th>
		...
		<tbody>
			<c:forEach items="${info.data }" var="merchant">
				<tr align="center">
