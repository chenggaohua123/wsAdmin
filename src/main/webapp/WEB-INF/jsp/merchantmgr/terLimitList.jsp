...
<body>
<form id="pagerForm" method="post" action="<%=path %>/merchantmgr/terLimitInfoList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/merchantmgr/terLimitInfoList" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<%=path %>/merchantmgr/addTerLimitGo" target="dialog" mask="true" width="650" height="500" title="增加终端配额信息"  rel="agentMerchant" ><span>增加配额</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="<%=path %>/merchantmgr/updateTerNoGo?id={sid_role}" target="dialog" mask="true" width="650" height="500" title="修改终端配额信息" ><span>修改配额</span></a></li>
			<li class="line">line</li>
			<li><a class="add" href="<%=path %>/merchantmgr/exportTerLimitInfo" target="dwzExport" mask="true" width="650" height="500"><span>导出配额信息</span></a></li>
			<li class="line">line</li>
		...
		<tbody>
			<c:forEach items="${page.data }" var="limit">
				<tr target="sid_role" rel="${limit.id }" align="center">
					...
					<td>${limit.amountOrCount=='0'?'金额':'笔数' }</td>
					<td>${limit.merchantName }</td>
					<td>${limit.settleCurrency }</td>
