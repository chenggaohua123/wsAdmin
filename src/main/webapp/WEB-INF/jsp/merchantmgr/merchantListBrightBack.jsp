...
<body>
<form id="pagerForm" method="post" action="<%=path %>/merchantmgr/getMerListbrighBack">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dialogSearch(this);" action="<%=path %>/merchantmgr/getMerListbrighBack" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<table class="list" width="98%" targetType="navTab" layoutH="115">
		...
		<tbody>
			<c:forEach items="${list.data }" var="merchant">
				<tr align="center">
