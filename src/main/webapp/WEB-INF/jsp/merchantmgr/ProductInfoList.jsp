...
<script type="text/javascript">
	function submitForm1(){
		if($("#ProductInfobpname").val().replace(/\s/g,"")!=''){
			$("#getProductInfo").submit();
		}
	}
</script>
...
<body>
<form id="pagerForm" method="post" action="<%=path %>/merchantmgr/getProductInfo">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" id="getProductInfo" action="<%=path %>/merchantmgr/getProductInfo" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>产品名称：</label>
				<input type="text" name="bpname" id="ProductInfobpname" value="${param.bpname}" />
			</li>
		</ul>
		<div class="subBar">
			<ul>
	...
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		...
		<tbody>
			<c:forEach items="${page.data }" var="terInfo">
				<tr>
				    <td><input type="checkbox" name="orgId"  value="{ product:'${terInfo.bpname }'}"/></td>
