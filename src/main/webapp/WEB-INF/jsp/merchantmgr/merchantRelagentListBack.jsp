...
<body>
<form id="pagerForm" method="post" action="<%=path %>/merchantmgr/merchantRelAgentBack">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dialogSearch(this);" action="<%=path %>/merchantmgr/merchantRelAgentBack" method="post">
	<div class="searchBar">
