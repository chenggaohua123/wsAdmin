...
<body>
<form id="pagerForm" method="post" action="<%=path %>/merchantmgr/merchantRelUserBack">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dialogSearch(this);" action="<%=path %>/merchantmgr/merchantRelUserBack" method="post">
	<div class="searchBar">
		...
		<tbody>
			<c:forEach items="${page.data }" var="user">
				<tr  align="center">
					...
					<td>
					  ${funcs:getStringColumnKey('SYSTEMID',user.systemId,'未知状态')}</td>
					<td><a class="btnSelect" href="javascript:$.bringBack({phoneNo:'${user.phoneNo }'})"  title="查找带回">选择</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
