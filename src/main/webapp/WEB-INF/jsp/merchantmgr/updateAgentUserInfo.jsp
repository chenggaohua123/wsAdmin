...
<div class="pageContent">
	<form method="post" action="<%=path %>/merchantmgr/updateAgentUserInfo" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            ...
            <p> 
                <label>登陆名：</label>
                <input name="loginAccount" type="text" size="30" value="${agentUser.loginAccount }" class="required" readonly="readonly"/>
            </p>
            <p> 
                <label>登陆密码：</label>
                <input name="loginPass" type="password" size="30" value="${agentUser.loginPass }" class="required" readonly="readonly"/>
            </p>
            <p>
                <label>用户名：</label> 
