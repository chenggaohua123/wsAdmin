...
<title>批量上传网站信息</title>
</head>
<body>
<font color="red"><b>上传注意事项:<br>
模式一:添加网站
1.上传文件为txt类型 <br>
2.文件内容:商户号、终端号、网站（、品牌）<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条网站信息<br>
例如:<br>
168,88816,www.taobao.com,Nike<br>
168,88816,www.taobao.com,YSL<br>
168,88816,www.taobao.com<br>
模式二：修改品牌
1.上传文件为txt类型 <br>
2.文件内容:商户号、终端号、网站、品牌<br>
3.分别用英文逗号隔开<br>
4.一行内容为一条网站信息<br>
例如:<br>
168|88816|www.taobao.com|Nike,YSL<br>
168|88816|www.taobao.com|YSL<br>
168|88816|www.taobao.com|YSL,Nike<br>
</b></font>
    ...
    <script type="text/javascript">
      $('#drag-and-drop-zone').dmUploader({
        url: '<%=path%>/merchantmgr/uploadMerchantWebsite',
        dataType: 'json',
        allowedTypes: 'text/*',
