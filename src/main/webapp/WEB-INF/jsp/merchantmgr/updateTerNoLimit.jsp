...
<div class="pageContent">
	<form method="post" action="<%=path %>/merchantmgr/updateTerNoLimit" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            ...
            <select class="combox" name="amountOrCount">
            	<option value="0" ${lmitInfo.amountOrCount==0?'selected':''}>金额</option>
            </select>
            </p>
            <p>
            <label>卡种：</label>
            ...
            <p>
                <label>单笔限额：</label>
                <input name="singleTransAmountLimit" type="text"  size="30" value="${lmitInfo.singleTransAmountLimit}" class="required"/>
            </p>
             <p>
                <label>日限额：</label>
