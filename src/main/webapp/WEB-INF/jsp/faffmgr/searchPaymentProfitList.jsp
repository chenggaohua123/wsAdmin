...
<body>
<form id="pagerForm" method="post" action="<%=path %>/faffmgr/searchPaymentProfitList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
</form>
<div class="pageHeader" id="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/faffmgr/searchPaymentProfitList" method="post">
	<div class="searchBar" >
