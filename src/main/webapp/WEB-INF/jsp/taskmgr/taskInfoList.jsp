...
<body>
 <form id="pagerForm" method="post" action="<%=path %>/taskmgr/queryTaskInfoList">
	<input type="hidden" name="pageNum" value="${page.nowPage }" />
	<input type="hidden" name="numPerPage" value="${page.pageSize}" />
 </form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=path %>/taskmgr/queryTaskInfoList" method="post">
	  <div class="searchBar">
  ...
  <div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		    <li><a class="add" href="<%=path %>/taskmgr/goAddTaskInfo" target="dialog" width="550" height="400" mask="true"  mask="true"  ><span>添加工作记录</span></a></li>
		    <li><a class="add" href="<%=path %>/taskmgr/goUpdateTaskInfo?id={id}" target="dialog" width="750" height="450" mask="true"><span>更新工作信息</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
	   <table class="list" width="100%" targetType="navTab" layoutH="142">
		<thead>
			<tr>
						<th>工作编号</th>
						<th>工作名称</th>
				...
				<tbody>
					<c:forEach items="${page.data }" var="taskInfo">
						<tr  target="id" rel="${taskInfo.id }"    align="center">
							<td>${taskInfo.id }</td>
